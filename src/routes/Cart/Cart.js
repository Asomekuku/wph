    ...
    return this.props.goods.map((ele, idx) => (
      <div key={idx} className="cart_good">
        ...
        <ul>
          ...
          <li>
            <span onClick={this.dian.bind(this, false, idx)}>
            ...
            <span onClick={this.dian.bind(this, true, idx)}>
