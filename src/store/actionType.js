//home
export const GET_HOME_SLIDESHOW = 'GET_HOME_SLIDESHOW'  //导航栏
export const GET_HOME_MAUN = 'GET_HOME_MAUN'  //菜单栏
export const GET_HOME_SWIPER = 'GET_HOME_SWIPER'  //轮播图
export const GET_HOME_NAV = 'GET_HOME_NAV'  //导航栏
...
export const SNAPLIST = 'SNAPLIST'  //疯抢页面的数据


export const GOOD_UPD = 'GOOD_UPD'      //存数据
export const GOOD_ADD = 'GOOD_ADD'      //加
export const GOOD_SUB = 'GOOD_SUB'      //减
